...
describe('Testing Resolvers - Type Root - Query', () => {
	...
	test("Comprobar que 'hello' devuelve correcto y es un string", async () => {
        const query = `
        { 
            hello 
        }`;
    ...
    test("Comprobar que 'helloWithName' devuelve correcto y es un string", async () => {
        const query = `
    ...
    test("Comprobar que 'helloToGraphQLCourse' devuelve correcto y es un string", async () => {
        const query = `
        { 
    ...
    test("Comprobar que 'list' devuelve correcto y tiene 0 elementos", async () => {
        const query = `
        { 
            list 
        }`;
